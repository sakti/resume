...
\item {\bf Development:} Go, Python, C, JavaScript, HTML, CSS, SQL, Java, Kotlin, TypeScript, Ruby, Bash

\item {\bf Database:} PostgreSQL (+ postgis), MySQL, MongoDB, HBase

\item {\bf CI/CD:} Buildbot, Drone CI
...
\item {\bf Text Editor:} VS Code, Vim, Sublime Text 2
