...
Diploma in Informatics Engineering & saktidc@outlook.com \\

Jl. Cigadung Selatan No.82, Cigadung, Cibeunying Kaler, Bandung & www.saktidwicahyono.name \\
...
\item {\bf CI/CD:} Gitlab CI, Buildbot, Drone CI

\item {\bf Cloud Platform:} Amazon AWS, GCP

\item {\bf Orchestration:} Kubernetes, Nomad
...
\item
	...
	\begin{itemize}
		...
		\resitem{"Development of Meeting Shedule Application Using Genetic Algorithm"}
